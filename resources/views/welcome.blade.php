...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div>
            ...
            <!-- Using foreach loop in $listItem--- -->
            @foreach ($listItems as $listItem)

            <!-- show the id of the $listItem--- -->
            <!-- @php
            echo $listItem->id;
            @endphp -->
        ...
        <div style="align-items: center; display: flex; justify-content:space-between">
           ...
           <!-- $listitem passing id value in the markComplete route--- -->
            ...
            <!-- When click save button hit the saveItem route--- -->
